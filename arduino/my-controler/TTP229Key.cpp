...
{*/
    struct CTtP229TouchButton::CTtp229Prop
    {
      uint16_t  SclPin : 6;
      uint16_t  SdoPin : 6;
    ...
    //
    static uint16_t CTtP229TouchButton::GetPressedButton()
    {
    ...
    static void CTtP229TouchButton::HandleButtonEvent()
    {
    ...
    static void CTtP229TouchButton::SetInterruptHandler()
    {
#ifdef INT0_PIN
    ...
    static void CTtP229TouchButton::RemoveInterruptHandler()
    {
#ifdef INT0_PIN
      if ( INT0_PIN == g_prop.SdoPin )
      {
    ...
    //
    static uint8_t CTtP229TouchButton::GetButtonNumberFromFlag(uint16_t buttonsChanged)
    {
      uint16_t flag = 1;
  ...
  //public:
    ...
    //
    static void CTtP229TouchButton::Configure(int sclPin, int sdoPin, bool is16Button = true)
    {
    ...
    //
    static uint16_t CTtP229TouchButton::GetButtonStatus()
    {
#if defined(INT0_PIN) || defined(INT1_PIN)
    ...
    //
    static CTtp229ButtonEvent CTtP229TouchButton::GetButtonEvent() 
    {
...
#if defined(INT0_PIN) || defined(INT1_PIN)
    static bool CTtP229TouchButton::HasEvent()
    {
#if defined(INT0_PIN)
      if ( INT0_PIN == g_prop.SdoPin )
      {
