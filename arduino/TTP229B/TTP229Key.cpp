...
{*/
    ...
    void CTtP229TouchButton::HandleButtonEvent()
    {
     ...
     void CTtP229TouchButton::SetInterruptHandler()
    {
#ifdef INT0_PIN
     ...
     void CTtP229TouchButton::RemoveInterruptHandler()
    {
#ifdef INT0_PIN
      if ( INT0_PIN == g_prop.SdoPin )
      {
  ...
  //public:
    ...
    //
     uint16_t CTtP229TouchButton::GetButtonStatus()
    {
#if defined(INT0_PIN) || defined(INT1_PIN)
...
#if defined(INT0_PIN) || defined(INT1_PIN)
     bool CTtP229TouchButton::HasEvent()
    {
#if defined(INT0_PIN)
      if ( INT0_PIN == g_prop.SdoPin )
      {
